...
export const OpenIdClient = Context.Tag('OpenIdClient')<BaseClient, BaseClient>()

const clientEffect = T.gen(function* (_) {
  const ZITADEL_CLIENT_ID = yield* _(
    Config.string('ZITADEL_CLIENT_ID'),
    T.catchAll(T.die)
  )
  return yield* _(
    T.promise(() =>
