  ...
  describe("User management", { timeout: 10000 }, () => {
    ...
    It(
      ...
      T.gen(function* () {
        ...
        const clientSecret =
          yield* userManagementService.createSecretForMachineUser(clientId);
    ...
    It(
      ...
      T.gen(function* () {
        ...
        const userProjectsWithRoles =
          yield* userManagementService.getCurrentUserProjectsWithRoles(userPAT);
    ...
    It(
      ...
      T.gen(function* () {
        ...
        const userProjectsWithRoles =
          yield* userManagementService.getUserProjectsWithRoles(userId);
        ...
        expect(
          pipe(
            ...
            A.findFirst(
              (r) =>
                r.projectId === project2Id && r.roleKeys.includes("Customer")
            ),
            O.isSome
          )
        ).equals(true);
